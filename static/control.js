...
async function renderInvestigationsEnhanced() {
  const [accounts,surveillance]=await Promise.all([cached("accounts","/admin/accounts?limit=500"),request("/admin/investigations/profit-surveillance")]),investigator=currentRoles().has("fec_investigator"),s=surveillance.settings||{},flags=surveillance.flags||[];
