...
function visibleSections() {
  ...
  if (roles.has("commissioner")) return sections;
...
async function renderOnboarding() {
  ...
  const policyPanel=`<article class="panel"><p class="eyebrow">PROVISIONING GUARDRAILS</p><h4>Role hierarchy is enforced server-side</h4><dl class="state-list"><div><dt>Administrative roles</dt><dd>Developer / Super Admin</dd></div><div><dt>Investigator accounts</dt><dd>FEC Administrator</dd></div><div><dt>Password storage</dt><dd>PBKDF2 hashed</dd></div><div><dt>Access changes</dt><dd>Audit logged</dd></div><div><dt>Deleted accounts</dt><dd>History retained</dd></div></dl></article>`;
